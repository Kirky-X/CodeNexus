...
> Nine end-to-end workflows using the verified 0.3.5 flag syntax. Part of the CodeNexus skill — see [SKILL.md](../SKILL.md) for the overview.

## Typical Workflows

> Every command below uses the **verified 0.3.5 flag syntax** (no positional args, mandatory flags supplied, booleans value-styled). `--project` accepts either name or id.
